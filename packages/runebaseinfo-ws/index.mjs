...
import {Transaction, Address} from 'runebaseinfo-lib'
import Service from 'runebaseinfo-node/lib/services/base'

export default class RunebaseinfoWebsocketService extends Service {
  constructor(options) {
    super(options)
