...
import { Base58Check, InvalidBase58Error, InvalidBase58ChecksumError } from './encoding/base58.mjs';
import SegwitAddress, { InvalidSegwitAddressError } from './encoding/segwit-address.mjs';
import OutputScript from './script/output.mjs';
const TYPES = {
    ...
    switch (script.type) {
      ...
      case OutputScript.EVM_CONTRACT_CREATE_SENDER:
        return new Address({
          ...
          data: Hash.sha256ripemd160(Buffer.concat([Buffer.from(transactionId).reverse(), getUInt32LEBuffer(outputIndex)])),
          chain
        });
...
export { PAY_TO_PUBLIC_KEY_HASH, PAY_TO_SCRIPT_HASH, PAY_TO_WITNESS_KEY_HASH, PAY_TO_WITNESS_SCRIPT_HASH, CONTRACT, EVM_CONTRACT };