...
function generate(sequelize) {
  ...
  let QRC20Balance = sequelize.define('qrc20_balance', {
    ...
    balance: {
      ...
      set(balance) {
        if (balance != null) {
          this.setDataValue('balance', Buffer.from(balance.toString(16).padStart(64, '0'), 'hex'));
        }
      }
    }
  }, {
  ...
  sequelize.models.contract.hasOne(QRC20, {
    as: 'qrc20',
    foreignKey: 'contractAddress'
  });
  QRC20.belongsTo(sequelize.models.contract, {
    as: 'contract',
    foreignKey: 'contractAddress'
  });
  sequelize.models.contract.hasMany(QRC20Balance, {
    as: 'qrc20Balances',
    foreignKey: 'contractAddress'
  });
  QRC20Balance.belongsTo(sequelize.models.contract, {
    as: 'contract',
    foreignKey: 'contractAddress'
  });
  sequelize.models.contract.hasOne(Qrc721, {
    as: 'qrc721',
    foreignKey: 'contractAddress'
  });
  Qrc721.belongsTo(sequelize.models.contract, {
    as: 'contract',
    foreignKey: 'contractAddress'
  });
  sequelize.models.contract.hasMany(QRC721Token, {
    as: 'qrc721Tokens',
    foreignKey: 'contractAddress'
  });
  QRC721Token.belongsTo(sequelize.models.contract, {
    as: 'contract',
    foreignKey: 'contractAddress'
  });
}
