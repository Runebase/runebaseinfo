...
function generate(sequelize) {
  ...
  sequelize.models.transaction.hasMany(BalanceChange, {
    as: 'balanceChanges',
    foreignKey: 'transactionId'
  });
  BalanceChange.belongsTo(sequelize.models.transaction, {
    as: 'transaction',
    foreignKey: 'transactionId'
  });
  sequelize.models.address.hasOne(BalanceChange, {
    as: 'balanceChanges',
    foreignKey: 'addressId'
  });
  BalanceChange.belongsTo(sequelize.models.address, {
    as: 'address',
    foreignKey: 'addressId'
  });
}
