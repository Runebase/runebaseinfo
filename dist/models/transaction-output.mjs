...
function generate(sequelize) {
  ...
  TransactionOutput.belongsTo(sequelize.models.transaction, {
    as: 'transaction',
    foreignKey: 'transactionId'
  });
  TransactionInput.belongsTo(sequelize.models.transaction, {
    as: 'transaction',
    foreignKey: 'transactionId'
  });
  TransactionInput.belongsTo(sequelize.models.address, {
    as: 'address',
