...
const {UNKNOWN, PUBKEY, PUBKEYHASH, SCRIPTHASH, MULTISIG, DATA,
  WITNESS_V0_KEYHASH, WITNESS_V0_SCRIPTHASH,
  EVM_CONTRACT_CREATE, EVM_CONTRACT_CREATE_SENDER,
  EVM_CONTRACT_CALL, EVM_CONTRACT_CALL_SENDER, CONTRACT} = TYPES
export {
  UNKNOWN, PUBKEY, PUBKEYHASH, SCRIPTHASH, MULTISIG, DATA,
  WITNESS_V0_KEYHASH, WITNESS_V0_SCRIPTHASH,
  EVM_CONTRACT_CREATE, EVM_CONTRACT_CREATE_SENDER,
  EVM_CONTRACT_CALL, EVM_CONTRACT_CALL_SENDER, CONTRACT
}
