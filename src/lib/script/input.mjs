...
const {UNKNOWN, COINBASE, PUBKEY, PUBKEYHASH, SCRIPTHASH,
  SCRIPTHASH_WRAP_MULTISIG, MULTISIG,
  SCRIPTHASH_WRAP_WITNESS_V0_KEYHASH, SCRIPTHASH_WRAP_WITNESS_V0_SCRIPTHASH,
  SCRIPTHASH_WRAP_WITNESS_V0_SCRIPTHASH_WRAP_MULTISIG,
  WITNESS_V0_KEYHASH, WITNESS_V0_SCRIPTHASH, CONTRACT_SPEND} = TYPES
export {
  UNKNOWN, COINBASE, PUBKEY, PUBKEYHASH, SCRIPTHASH,
  SCRIPTHASH_WRAP_MULTISIG, MULTISIG,
  SCRIPTHASH_WRAP_WITNESS_V0_KEYHASH, SCRIPTHASH_WRAP_WITNESS_V0_SCRIPTHASH,
  SCRIPTHASH_WRAP_WITNESS_V0_SCRIPTHASH_WRAP_MULTISIG,
  WITNESS_V0_KEYHASH, WITNESS_V0_SCRIPTHASH, CONTRACT_SPEND
}
