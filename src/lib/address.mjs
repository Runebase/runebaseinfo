...
const {PAY_TO_PUBLIC_KEY_HASH, PAY_TO_SCRIPT_HASH, PAY_TO_WITNESS_KEY_HASH,
  PAY_TO_WITNESS_SCRIPT_HASH, CONTRACT, EVM_CONTRACT} = TYPES
export {
  PAY_TO_PUBLIC_KEY_HASH, PAY_TO_SCRIPT_HASH, PAY_TO_WITNESS_KEY_HASH,
  PAY_TO_WITNESS_SCRIPT_HASH, CONTRACT, EVM_CONTRACT
}
